...
<html lang="en">
    ...
    <head>
        ...
        <meta name="msapplication-TileColor" content="#070e16">
        <meta name="msapplication-config" content="/img/favicon/browserconfig.xml">
        <meta name="theme-color" content="#070e16">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">Group 18</span>
                ...
                <ul class="navbar-nav">
                    <?php
                        ...
                        if (isset($data) && $data->num_rows > 0) {
                            ...
                            echo '
                                <li class="nav-item">
                                    <a class="nav-link js-scroll-trigger" href="http://localhost:8501">Diet Recommendation</a>
                                    <a class="nav-link js-scroll-trigger" href="modul\WorkoutPlanner\workoutPlanner.php">Workout Planner</a>
                                </li>
                                ';
                            }
                        }
